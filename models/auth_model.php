...
class Auth_model extends CI_Model {
	...
	function login()
	{
		...
		{	
			...
			$this->data['message'] = validation_errors('<div class="alert alert-danger">', '</div>');
	...
	function register_account()
	{
		...
		$validation_rules = array(
			array('field' => 'register_displayname', 'label' => 'Display Name', 'rules' => 'required|min_length[4]'),
	...
	function update_account()
	{
		...
		$validation_rules = array(
			array('field' => 'update_displayname', 'label' => 'Display Name', 'rules' => 'required|min_length[4]')
		);
		...
		if ($this->form_validation->run())
		{
			...
			$profile_data = array(
				...
				'upro_displayname' => $this->input->post('update_displayname'),
			);
			...
			// Redirect user.
			($response) ? redirect('account/dashboard') : redirect('account/update_account');
		}
		else
		{		
			// Set validation errors.
	...
	function change_password()
	{
		...
		if ($this->form_validation->run())
		{
			...
			($response) ? redirect('account/dashboard') : redirect('account/change_password');
		}
		else
		{		
			// Set validation errors.
	...
	function manage_address_book()
	{
		...
		// Redirect user.
		redirect('account/manage_address_book');
	}
	...
	function insert_address()
	{
		...
		if ($this->form_validation->run())
		{
			...
			// Redirect user.
			($response) ? redirect('account/manage_address_book') : redirect('account/insert_address');
		}
		else
		{		
			// Set validation errors.
	...
	function update_address($address_id)
	{
		...
		if ($this->form_validation->run())
		{
			...
			*/
			...
			// Redirect user.
			($response) ? redirect('account/manage_address_book') : redirect('account/update_address');
		}
		else
		{		
			// Set validation errors.
